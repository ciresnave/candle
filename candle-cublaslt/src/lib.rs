//! CUBLASLt fused GEMM operations for the Candle ML framework.
//!
...
//!
//! This crate wraps the `cudarc` cuBLASLt bindings and exposes them as Candle
//! [`CustomOp2`](candle::CustomOp2) and [`CustomOp3`](candle::CustomOp3) operations,
//! so they integrate naturally with Candle's autograd and device management.
//!
//! # Example
//!
//! ```no_run
//! use candle::{Device, DType, Tensor};
//! use candle_cublaslt::{CublasLt, fused_matmul};
//!
