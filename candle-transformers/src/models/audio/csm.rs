...
use candle_nn::{embedding, kv_cache::KvCache, linear_b, Embedding, Linear, RmsNorm, VarBuilder};
...
///
/// ```
/// use candle_transformers::models::csm::Flavor;
...
///
/// ```
/// use candle_transformers::models::csm::{Config, Flavor};
/// let cfg = Config {
...
///
/// ```
/// use candle_transformers::models::csm::{Flavor, LlamaConfig};
...
///
/// ```no_run
/// # use candle_transformers::models::csm::{Flavor, LlamaConfig, LlamaModel};
...
impl LlamaModel {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::csm::LlamaModel;
...
impl Model {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::csm::Model;
