...
///
/// ```
/// use candle_transformers::models::encodec::NormType;
...
///
/// ```
/// use candle_transformers::models::encodec::PadMode;
...
///
/// ```
/// use candle_transformers::models::encodec::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, conv1d_weight_norm};
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::conv1d_weight_norm_no_bias;
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
...
impl candle::CustomOp2 for CodebookEncode {
    ...
    fn cpu_fwd(
        ...
        let dst = (0..lhs_dim1)
            ...
            .collect();
        let storage = candle::CpuStorage::U32(dst);
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, EuclideanCodebook};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, VectorQuantization};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, ResidualVectorQuantizer};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, EncodecLSTM};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, EncodecConv1d};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, EncodecResnetBlock};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, Encoder};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::encodec::{Config, Decoder};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
