...
///
/// ```no_run
/// use candle_transformers::models::parler_tts::DecoderConfig;
...
///
/// ```no_run
/// use candle_transformers::models::parler_tts::Config;
...
/// use candle_transformers::models::parler_tts::{Decoder, DecoderConfig};
...
impl Decoder {
    ...
    /// # let encoder_xs: candle::Tensor = unimplemented!();
...
impl Model {
    ...
    /// # let prompt_tokens: candle::Tensor = unimplemented!();
    /// # let description_tokens: candle::Tensor = unimplemented!();
