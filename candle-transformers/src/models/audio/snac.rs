...
///
/// ```no_run
/// # let cfg: candle_transformers::models::snac::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
///
/// This is the Candle equivalent of `torch.repeat_interleave`.
///
/// # Example
///
/// ```
/// use candle_transformers::models::snac::repeat_interleave;
...
///
/// ```no_run
/// # use candle_transformers::models::snac::conv1d_weight_norm;
...
///
/// ```no_run
/// # use candle_transformers::models::snac::conv1d_weight_norm_no_bias;
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
...
///
/// ```no_run
/// # use candle_transformers::models::snac::conv_transpose1d_weight_norm;
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
