...
///
/// ```
/// use candle_transformers::models::distilbert::HiddenAct;
...
///
/// ```
/// use candle_transformers::models::distilbert::PositionEmbeddingType;
...
///
/// ```no_run
/// # use candle_transformers::models::distilbert::{Config, DistilBertLMPredictionHead};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::distilbert::{Config, DistilBertOnlyMLMHead};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
...
///
/// ```no_run
/// # use candle_transformers::models::distilbert::{Config, DistilBertForMaskedLM};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::default();
