...
///
/// ```no_run
/// # let cfg: candle_transformers::models::modernbert::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
///
/// ```
/// use candle_transformers::models::modernbert::ClassifierPooling;
...
///
/// ```no_run
/// # let cc: candle_transformers::models::modernbert::ClassifierConfig = unimplemented!(); // Loaded from JSON
/// ```
#[derive(Debug, Clone, PartialEq, Deserialize)]
