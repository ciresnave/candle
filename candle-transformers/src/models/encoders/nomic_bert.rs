...
///
/// ```
/// use candle_transformers::models::nomic_bert::Config;
...
///
/// ```
/// use candle_transformers::models::nomic_bert::mean_pooling;
/// use candle::{Device, DType, Tensor};
...
///
/// ```
/// use candle_transformers::models::nomic_bert::l2_normalize;
/// use candle::{Device, DType, Tensor};
