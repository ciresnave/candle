...
///
/// ```
/// use candle_transformers::models::stella_en_v5::ModelVariant;
...
///
/// ```
/// use candle_transformers::models::stella_en_v5::{Config, EmbedDim};
...
///
/// ```
/// use candle_transformers::models::stella_en_v5::EmbedHead;
...
///
/// ```
/// use candle_transformers::models::stella_en_v5::{EmbedDim, EmbedHead};
...
impl EmbedDim {
    ...
    ///
    /// ```
    /// use candle_transformers::models::stella_en_v5::EmbedDim;
...
///
/// ```no_run
/// use candle_transformers::models::stella_en_v5::{Config, EmbedDim, Embeddings};
...
///
/// ```no_run
/// use candle_transformers::models::stella_en_v5::{Config, EmbedDim, Model};
/// # let vb: candle_nn::VarBuilder = unimplemented!();
/// let cfg = Config::new_1_5_b_v5(EmbedDim::Dim1024);
...
impl Model {
    ...
    /// # let mask: candle::Tensor = unimplemented!();
...
/// # let base_vb: candle_nn::VarBuilder = unimplemented!();
/// # let embed_vb: candle_nn::VarBuilder = unimplemented!();
/// let cfg = Config::new_1_5_b_v5(EmbedDim::Dim1024);
...
impl EmbeddingModel {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::stella_en_v5::EmbeddingModel;
