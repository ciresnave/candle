...
///
/// ```no_run
/// # let cfg: candle_transformers::models::xlm_roberta::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
///
/// ```no_run
/// # use candle_transformers::models::xlm_roberta::{Config, XLMRobertaForMaskedLM};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
