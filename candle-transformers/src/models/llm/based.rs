...
///
/// ```no_run
/// # use candle_transformers::models::based::LinearAttentionFeatureMapConfig;
...
///
/// ```no_run
/// # use candle_transformers::models::based::LinearAttentionConfig;
...
///
/// ```no_run
/// # use candle_transformers::models::based::SlidingWindowAttentionConfig;
...
///
/// ```no_run
/// # use candle_transformers::models::based::Config;
