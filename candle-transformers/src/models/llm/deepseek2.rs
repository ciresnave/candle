...
use candle_nn::{embedding, kv_cache::KvCache, rms_norm, Activation, Embedding, Linear, Module, RmsNorm, VarBuilder};
...
/// # let tensor: candle::Tensor = unimplemented!();
...
///
/// ```no_run
/// use candle_transformers::models::deepseek2::DeepSeekV2Config;
...
///
/// ```
/// use candle_transformers::models::deepseek2::ScaledRopeType;
...
/// use candle::DType;
/// # let dev: candle::Device = unimplemented!();
...
///
/// ```
/// use candle_transformers::models::deepseek2::DeepSeekV2RopeConfig;
...
impl DeepSeekV2RotaryEmbedding {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::deepseek2::DeepSeekV2RotaryEmbedding;
    /// # let rope: DeepSeekV2RotaryEmbedding = unimplemented!();
    /// # let q: candle::Tensor = unimplemented!();
    /// # let k: candle::Tensor = unimplemented!();
