...
use candle_nn::{kv_cache::KvCache, linear_b as linear, Activation, Linear, VarBuilder};
...
impl Attention {
    ...
    fn forward(
        ...
        let attn_output =
            candle_nn::ops::sdpa(&query_states, &key_states, &value_states, attention_mask, false, scale, softcapping)?;
        attn_output
            .transpose(1, 2)?
            .reshape((b_sz, q_len, ()))?
            .apply(&self.o_proj)
