...
use candle_nn::{kv_cache::KvCache, VarBuilder};
...
///
/// ```
/// use candle_transformers::models::glm4::EosTokenId;
...
///
/// ```no_run
/// # use candle_transformers::models::glm4::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::glm4::{Config, Model};
...
impl Model {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::glm4::Model;
