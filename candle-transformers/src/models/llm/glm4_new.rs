...
///
/// ```no_run
/// # use candle_transformers::models::glm4_new::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::glm4_new::{Config, Model};
...
impl Model {
    ...
    /// # use candle_transformers::models::glm4_new::Model;
...
///
/// ```no_run
/// # use candle_transformers::models::glm4_new::{Config, ModelForCausalLM};
/// # use candle_nn::VarBuilder;
/// # let cfg: Config = unimplemented!();
/// # let vb: VarBuilder = unimplemented!();
...
impl ModelForCausalLM {
    ...
    /// ```no_run
    /// # use candle::{DType, Device, Tensor};
    /// # use candle_transformers::models::glm4_new::ModelForCausalLM;
