...
use candle_nn::{kv_cache::KvCache, Module, VarBuilder};
...
///
/// ```
/// use candle_transformers::models::helium::Config;
...
///
/// ```no_run
/// use candle_transformers::models::helium::{Model, Config};
...
impl Model {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::helium::Model;
