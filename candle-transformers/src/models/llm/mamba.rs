...
///
/// ```
/// use candle_transformers::models::mamba::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::mamba::{Config, MambaBlock};
...
impl MambaBlock {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::mamba::{Config, MambaBlock, State};
...
///
/// ```no_run
/// # use candle_transformers::models::mamba::{Config, ResidualBlock};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config { d_model: 256, n_layer: 4, vocab_size: 50280, pad_vocab_size_multiple: 8 };
