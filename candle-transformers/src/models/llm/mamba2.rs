...
///
/// ```
/// use candle_transformers::models::mamba2::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::mamba2::{Config, Mamba2Block};
...
impl Mamba2Block {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::mamba2::{Config, Mamba2Block, State};
...
///
/// ```no_run
/// # use candle_transformers::models::mamba2::{Config, ResidualBlock};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
...
///
/// ```no_run
/// # use candle_transformers::models::mamba2::{Config, Model};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
