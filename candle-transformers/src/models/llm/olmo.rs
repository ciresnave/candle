...
use candle_nn::{kv_cache::KvCache, linear_b, linear_no_bias, Activation, LayerNorm, Linear, VarBuilder};
...
///
/// ```no_run
/// use candle_transformers::models::olmo::{Model, Config};
...
impl Model {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::olmo::Model;
