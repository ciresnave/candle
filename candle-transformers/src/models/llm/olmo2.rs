...
use candle_nn::{kv_cache::KvCache, linear_b, linear_no_bias, rms_norm, Activation, Linear, RmsNorm, VarBuilder};
...
///
/// ```no_run
/// use candle_transformers::models::olmo2::{Model, Config};
...
impl Model {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::olmo2::Model;
