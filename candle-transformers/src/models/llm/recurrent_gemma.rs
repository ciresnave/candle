...
use candle_nn::{kv_cache::KvCache, linear_b as linear, Linear, VarBuilder};
...
///
/// ```
/// use candle_transformers::models::recurrent_gemma::TemporalBlockType;
...
///
/// ```no_run
/// # let cfg: candle_transformers::models::recurrent_gemma::Config = unimplemented!(); // Typically loaded from JSON
/// ```
