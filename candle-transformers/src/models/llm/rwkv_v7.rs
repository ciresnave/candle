...
///
/// ```no_run
/// # let cfg: candle_transformers::models::rwkv_v7::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
///
/// ```no_run
/// # use candle_transformers::models::rwkv_v7::{Config, Model};
...
impl Model {
    ...
    ///
    /// ```no_run
    /// # use candle_transformers::models::rwkv_v7::{Config, Model, State};
