...
/// # Example
/// ```no_run
/// # use candle_transformers::models::t5::linear_no_bias;
...
/// # Example
/// ```
/// use candle_transformers::models::t5::ActivationWithOptionalGating;
...
/// else is passed to [`serde_plain`] for the non-gated [`candle_nn::Activation`].
///
/// # Example
/// ```no_run
/// # use serde::Deserialize;
/// # use candle_transformers::models::t5::{ActivationWithOptionalGating, deserialize_feed_forward_proj_activation};
/// #[derive(Deserialize)]
/// struct Cfg {
...
impl T5ForConditionalGeneration {
    ...
    /// # Example
    /// ```no_run
    /// # use candle_transformers::models::t5::T5ForConditionalGeneration;
    /// # use candle::{Device, DType, Tensor};
    /// # fn main() -> candle::Result<()> {
