...
///
/// ```
/// use candle_transformers::models::blip::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::blip_text::{Config, TextPooler};
...
///
/// ```no_run
/// # use candle_transformers::models::blip_text::{Config, TextLMHeadModel};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
