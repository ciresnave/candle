...
/// # Example
/// ```
/// use candle_transformers::models::chinese_clip::text_model::ChineseClipTextConfig;
...
impl ChineseClipTextEmbeddings {
    ...
    /// use candle_transformers::models::chinese_clip::text_model::{ChineseClipTextEmbeddings, ChineseClipTextConfig};
    /// let config = ChineseClipTextConfig::clip_vit_base_patch16();
...
impl ChineseClipTextTransformer {
    ...
    /// use candle::Device;
    /// use candle_nn::VarBuilder;
    /// use candle_transformers::models::chinese_clip::text_model::{ChineseClipTextTransformer, ChineseClipTextConfig};
    /// let config = ChineseClipTextConfig::clip_vit_base_patch16();
    /// let vb = VarBuilder::zeros(candle::DType::F32, &Device::Cpu);
    ...
    /// let vb = VarBuilder::zeros(candle::DType::F32, &Device::Cpu);
    /// let model = ChineseClipTextTransformer::new(vb, &config)?;
    /// let ids = Tensor::zeros((1usize, 16usize), candle::DType::U32, &Device::Cpu)?;
