...
/// # Example
/// ```
/// use candle_transformers::models::chinese_clip::vision_model::ChineseClipVisionConfig;
...
impl ChineseClipVisionEmbeddings {
    ...
    /// use candle_transformers::models::chinese_clip::vision_model::{ChineseClipVisionEmbeddings, ChineseClipVisionConfig};
    /// let config = ChineseClipVisionConfig::clip_vit_base_patch16();
...
impl ChineseClipVisionEncoder {
    ...
    /// use candle_transformers::models::chinese_clip::vision_model::ChineseClipVisionEncoder;
...
impl ChineseClipVisionTransformer {
    ...
    /// use candle::Device;
    /// use candle_nn::VarBuilder;
    /// use candle_transformers::models::chinese_clip::vision_model::{ChineseClipVisionTransformer, ChineseClipVisionConfig};
    /// let config = ChineseClipVisionConfig::clip_vit_base_patch16();
    /// let vb = VarBuilder::zeros(candle::DType::F32, &Device::Cpu);
