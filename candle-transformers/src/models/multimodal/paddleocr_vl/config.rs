...
impl Default for VisionConfig {
    ...
    /// # Example
    /// ```
    /// use candle_transformers::models::paddleocr_vl::config::VisionConfig;
...
impl Default for Config {
    ...
    /// # Example
    /// ```
    /// use candle_transformers::models::paddleocr_vl::config::Config;
...
impl From<&Config> for TextConfig {
    ...
    /// # Example
    /// ```
    /// use candle_transformers::models::paddleocr_vl::config::{Config, TextConfig};
    /// let cfg = Config::default();
