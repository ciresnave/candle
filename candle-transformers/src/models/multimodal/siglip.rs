...
/// # Example
/// ```
/// use candle_transformers::models::siglip::TextConfig;
...
/// # Example
/// ```
/// use candle_transformers::models::siglip::Config;
...
/// # Example
/// ```no_run
/// # use candle_transformers::models::siglip::{TextConfig, TextTransformer};
/// # use candle_nn::VarBuilder;
/// # fn main() -> candle::Result<()> {
...
/// # Example
/// ```no_run
/// # use candle_transformers::models::siglip::{TextConfig, TextModel};
/// # use candle_nn::VarBuilder;
/// # fn main() -> candle::Result<()> {
/// # let vb: VarBuilder = unimplemented!();
...
impl Model {
    ...
    /// # Example
    /// ```no_run
    /// # use candle_transformers::models::siglip::Model;
