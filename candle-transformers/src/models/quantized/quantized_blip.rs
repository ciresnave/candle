...
///
/// ```no_run
/// use candle_transformers::models::quantized_blip::{BlipForConditionalGeneration, Config, VisionModel};
/// use candle_transformers::models::quantized_blip::VarBuilder;
...
///
/// ```no_run
/// use candle_transformers::models::quantized_blip::{BlipForConditionalGeneration, Config};
/// use candle_transformers::models::quantized_blip::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
/// let model = BlipForConditionalGeneration::new(&cfg, vb)?;
...
impl BlipForConditionalGeneration {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_blip::{BlipForConditionalGeneration, VisionModel};
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_blip::BlipForConditionalGeneration;
    /// use candle_transformers::models::quantized_blip_text::TextLMHeadModel;
