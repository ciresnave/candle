...
///
/// ```no_run
/// use candle_transformers::models::quantized_blip_text::{TextPooler, Config};
/// use candle_transformers::models::quantized_blip_text::VarBuilder;
...
///
/// ```no_run
/// use candle_transformers::models::quantized_blip_text::{TextLMHeadModel, Config};
/// use candle_transformers::models::quantized_blip_text::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
...
impl TextLMHeadModel {
    ...
    /// let enc = Tensor::zeros((1, 8, 768), candle::DType::F32, &Device::Cpu)?;
