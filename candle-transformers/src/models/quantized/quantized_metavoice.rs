...
pub mod transformer {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_metavoice::transformer::Model;
    /// use candle_transformers::models::metavoice::transformer::Config;
    /// use candle_transformers::models::quantized_metavoice::VarBuilder;
    ...
    impl Model {
        ...
        /// let spk = Tensor::zeros((1, 1, 512), candle::DType::F32, &Device::Cpu)?;
