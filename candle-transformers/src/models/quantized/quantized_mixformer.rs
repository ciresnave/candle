...
///
/// ```no_run
/// use candle_transformers::models::quantized_mixformer::{MixFormerSequentialForCausalLM, Config};
/// use candle_transformers::models::quantized_mixformer::VarBuilder;
/// use candle::Device;
...
impl MixFormerSequentialForCausalLM {
    ...
    /// use candle::{Device, Tensor};
    /// # let mut model: MixFormerSequentialForCausalLM = unimplemented!();
    /// let bos = Tensor::zeros((1, 1), candle::DType::U32, &Device::Cpu)?;
    /// let ids = Tensor::zeros((1, 4), candle::DType::U32, &Device::Cpu)?;
    /// let img = Tensor::zeros((1, 16, 2048), candle::DType::F32, &Device::Cpu)?;
