...
///
/// ```no_run
/// use candle_transformers::models::quantized_moondream::{VisionEncoder};
/// use candle_transformers::models::moondream::VisionConfig;
...
impl Model {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_moondream::{Model, VisionEncoder};
