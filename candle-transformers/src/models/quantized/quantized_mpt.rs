...
///
/// ```no_run
/// use candle_transformers::models::quantized_mpt::{Model, Config};
/// use candle_transformers::models::quantized_mpt::VarBuilder;
/// use candle::Device;
...
impl Model {
    ...
    /// # Example
    /// ```no_run
    /// # use candle_transformers::models::quantized_mpt::Model;
    /// # use candle_transformers::models::quantized_mpt::VarBuilder;
    /// # fn main() -> candle::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: candle_transformers::models::mpt::Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
    /// # Ok(())
    /// # }
    /// ```
