...
///
/// ```no_run
/// use candle_transformers::models::quantized_qwen3_moe::QuantizedAttention;
...
///     &mut gg, "blk.0", candle::DType::F16,
///     32, 8, 128, 1e-6, &candle::Device::Cpu, rotary,
/// )?;
/// # Ok::<_, candle::Error>(())
/// ```
...
impl QuantizedAttention {
    ...
    /// let x = Tensor::zeros((1, 4, 4096), candle::DType::F16, &Device::Cpu)?;
...
/// # let ct: candle::quantized::gguf_file::Content = unimplemented!();
