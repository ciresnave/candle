...
///
/// ```no_run
/// use candle_transformers::models::quantized_rwkv_v5::{Model, Config, State};
/// use candle_transformers::models::quantized_rwkv_v5::VarBuilder;
...
impl Model {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_rwkv_v5::{Model, Config};
    /// use candle_transformers::models::quantized_rwkv_v5::VarBuilder;
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_rwkv_v5::{Model, State, Config};
