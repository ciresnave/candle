...
///
/// ```no_run
/// use candle_transformers::models::quantized_stable_lm::{Model, Config};
/// use candle_transformers::models::quantized_stable_lm::VarBuilder;
/// use candle::Device;
...
impl Model {
    ...
    /// # Example
    /// ```no_run
    /// # use candle_transformers::models::quantized_stable_lm::Model;
    /// # use candle_transformers::models::quantized_stable_lm::VarBuilder;
    /// # fn main() -> candle::Result<()> {
    /// # let vb: VarBuilder = unimplemented!();
    /// # let cfg: candle_transformers::models::stable_lm::Config = unimplemented!();
    /// let model = Model::new(&cfg, vb)?;
    /// # Ok(())
    /// # }
    /// ```
