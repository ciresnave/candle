...
///
/// ```
/// use candle_transformers::models::quantized_t5::Config;
...
///
/// ```no_run
/// use candle_transformers::models::quantized_t5::{T5EncoderModel, Config};
/// use candle_transformers::models::quantized_t5::VarBuilder;
/// use candle::Device;
...
impl T5EncoderModel {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_t5::T5EncoderModel;
...
///
/// ```no_run
/// use candle_transformers::models::quantized_t5::{T5ForConditionalGeneration, Config};
/// use candle_transformers::models::quantized_t5::VarBuilder;
/// use candle::Device;
/// # let vb: VarBuilder = unimplemented!();
...
impl T5ForConditionalGeneration {
    ...
    ///
    /// ```no_run
    /// use candle_transformers::models::quantized_t5::T5ForConditionalGeneration;
    /// use candle::{Device, Tensor};
    ...
    /// use candle::{Device, Tensor};
    /// # let mut model: T5ForConditionalGeneration = unimplemented!();
    /// let enc_ids = Tensor::zeros((1, 8), candle::DType::U32, &Device::Cpu)?;
    /// let dec_ids = Tensor::zeros((1, 1), candle::DType::U32, &Device::Cpu)?;
