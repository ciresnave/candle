...
///
/// ```
/// use candle_transformers::models::fastvit::Config;
/// let cfg = Config::t8();
...
///
/// ```no_run
/// # use candle_transformers::models::fastvit::{fastvit, Config};
...
///
/// ```no_run
/// # use candle_transformers::models::fastvit::{fastvit_no_final_layer, Config};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::t8();
