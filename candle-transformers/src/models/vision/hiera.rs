...
///
/// ```
/// use candle_transformers::models::hiera::Config;
/// let cfg = Config::tiny();
/// ```
...
///
/// ```no_run
/// # use candle_transformers::models::hiera::{hiera, Config};
...
///
/// ```no_run
/// # use candle_transformers::models::hiera::{hiera_no_final_layer, Config};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::tiny();
