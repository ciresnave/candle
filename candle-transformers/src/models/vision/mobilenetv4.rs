...
///
/// ```
/// use candle_transformers::models::mobilenetv4::Config;
...
///
/// ```no_run
/// # use candle_transformers::models::mobilenetv4::{mobilenetv4, Config};
...
///
/// ```no_run
/// # use candle_transformers::models::mobilenetv4::{mobilenetv4_no_final_layer, Config};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::small();
