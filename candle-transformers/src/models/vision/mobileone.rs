...
///
/// ```
/// use candle_transformers::models::mobileone::Config;
/// let cfg = Config::s0();
/// ```
pub struct Config {
...
///
/// ```no_run
/// # use candle_transformers::models::mobileone::{mobileone, Config};
...
///
/// ```no_run
/// # use candle_transformers::models::mobileone::{mobileone_no_final_layer, Config};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::s0();
