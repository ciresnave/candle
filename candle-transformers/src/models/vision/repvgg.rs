...
///
/// ```
/// use candle_transformers::models::repvgg::Config;
/// let cfg = Config::a0();
/// ```
#[derive(Clone)]
pub struct Config {
...
///
/// ```no_run
/// # use candle_transformers::models::repvgg::{repvgg, Config};
...
///
/// ```no_run
/// # use candle_transformers::models::repvgg::{repvgg_no_final_layer, Config};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// let cfg = Config::a0();
