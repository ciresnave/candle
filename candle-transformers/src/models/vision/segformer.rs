...
///
/// ```no_run
/// # let cfg: candle_transformers::models::segformer::Config = unimplemented!(); // Typically loaded from JSON
/// ```
...
///
/// ```no_run
/// # use candle_transformers::models::segformer::{Config, SemanticSegmentationModel};
...
///
/// ```no_run
/// # use candle_transformers::models::segformer::{Config, ImageClassificationModel};
/// # use candle_nn::VarBuilder;
/// # let vb: VarBuilder = unimplemented!();
/// # let cfg: Config = unimplemented!();
